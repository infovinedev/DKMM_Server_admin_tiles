  ...
  summernote: function summernote() {
    ...
    this.each(function (idx, note) {
      ...
      if (!$note.data('summernote')) {
        ...
        context.layoutInfo.editable[0].id = "edittable_" + $note[0].id;
        context.layoutInfo.editor[0].id = "editor_" + $note[0].id;
...
var editable = renderer["a" /* default */].create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true" id="temp" />');
